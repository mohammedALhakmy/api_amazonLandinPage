        ...
        <Carousel :items-to-show="1" :wrap-around="true">
            <Slide v-for="slide in 6" :key="slide">
                <div class="carousel__item">
                    <img id="slide" :src="`images/carousel/slide${slide}.jpg`" alt="Placeholder Image">
<!--                    <img :src="`https://placehold.co/3000x1200?text=testing${slide}`" alt="Placeholder Image">-->
                </div>
            </Slide>
            <template #addons>
                <Navigation />
        ...
        <div class="relative -mt-[300px]">
            <div class="flex m-4 z-10 relative">
                <div class="bg-white mx-2 p-2 text-xl w-full text-center">
            ...
            <div class="grid grid-cols-3 m-4 z-10 relative">
               <div class="p-1.5 flex" v-for="cat in $page.props.categories" :key="cat">
                   <Link :href="route('category.index',{id:cat.id})" class="bg-white p-5">
                       <div class="text-2xl font-semibold flex">{{cat.name}}</div>
                       <div class="flex">
